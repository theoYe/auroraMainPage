<?php
/* Smarty version 3.1.33, created on 2019-08-06 17:56:07
  from '/var/www/html/wordpress/aurora/App/Home/View/Index/index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d494eb7bb2037_71153117',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1316d09221993429916a5278bdf52dfb3505cb2b' => 
    array (
      0 => '/var/www/html/wordpress/aurora/App/Home/View/Index/index.html',
      1 => 1565077206,
      2 => 'file',
    ),
  ),
...
function content_5d494eb7bb2037_71153117 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto text-center">
                        <h2 class="title">实验室简介</h2>
                        <h5 class="description">中南大学极光网络安全协会成立于2016年，由网络空间安全系支持、部分信息安全专业学生负责，是一个旨在培养在校大学生在网络安全领域中的创新能力和实践能力的社团，为中南大学校内信息安全爱好者提供了一个相互交流的平台。协会积极响应全国信息安全工作小组提出的“建设信息安全强国”口号，投身于营造全校性的网络安全氛围，普及网络安全知识，以促进中南大学在高校网络安全领域影响力的提升为宗旨，不断培养、选拔优秀网络安全人才，提升校内整体的网络安全素养，促进中南大学网络安全领域的可持续发展。</h5>
                    </div>
                </div>
                ...
                <div class="section-story-overview">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="image-container image-left" style="background-image: url('<?php echo @constant('IMAGES_DIR');?>
aurora2.jpeg')">
                                ...
                                <p class="blockquote blockquote-primary">
                                   <strong>团队经历:</strong>
                                    ...
                                    <br>
                                    在2017年秋季学期，实验室2015级6名主要成员共计获得国家级奖项四项、省级奖项两项，参加赛事包括CTF竞赛“湖湘杯”、“强网杯”等，团队最好成绩为2017年12月获得全国高校互联网应用创新大赛安全技能赛全国第一名
                                2017年举办中南大学首届信息安全技能赛，举办校园信息安全沙龙
                                2018“湖湘杯”关键信息基础设施网络安全应急演练大赛以“极光队“为名出战，获得二等奖，位列高校组第一
                                    <br>
                                    <small></small>
                                </p>
                            </div>
                            <!-- Second image on the left side of the article -->
                            <div class="image-container" style="background-image: url('<?php echo @constant('IMAGES_DIR');?>
aurora3.jpeg')"></div>
                        </div>
                        <div class="col-md-5">
                            <!-- First image on the right side, above the article -->
                            <div class="image-container image-right" style="background-image: url('<?php echo @constant('IMAGES_DIR');?>
aurora4.jpeg')"></div>
                            <h3>一封真挚的邀请函:</h3>
                            <p>极光实验室创立三年以来，在学长学姐的带领下，一届又一届对于网络安全有着浓厚兴趣的信安专业或是非信安专业的同学加入了我们，为实验室注入了新的血液与活力。
                            </p>
                            <h4>在此，我们诚挚地对你发出邀请：</h4>
                            <p>
                                    如果你热爱安全研究，善于团队合作；如果你想拥有宝贵专业指导、丰富的学习资料；如果你想参与各大安全类比赛，提高实战能力，得到实习机会；如果你想得到保研学长学姐，或是腾讯、华为工作大佬的学习经验……那么，极光网络实验室一定是你不二的选择！我们期待你们的加入！
                            </p>
                            <h4>主要工作</h4>
                            <p>
                                    —普及信息安全知识（举办中南大学首届信息安全技能赛，举办校园信息安全沙龙） <br>
                                    —参加国内外信息安全竞赛（参加ctf比赛，awd线下攻防赛，应急演练渗透赛等）<br>
                                    —参与老师课题工作（如参与病毒样本分析，攻击流量分析等）<br>
                                    —挖掘校园网站漏洞，协助信息网络中心复检漏洞等                            </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="team">
                    <div class="row">
                        <!-- team player start -->
                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['member_on']->value, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
                        <div class="col-md-4">
...
" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised"></a>
                                
                                <h4 class="title"><?php echo $_smarty_tpl->tpl_vars['row']->value['member_name'];?>
</h4>
                                <p class="category text-primary"><?php echo $_smarty_tpl->tpl_vars['row']->value['group_name'];?>
</p>
                                ...
                                <a href="#pablo" class="btn btn-primary btn-icon btn-round"><i class="fa fa-qq"></i></a>
                                <a href="#pablo" class="btn btn-primary btn-icon btn-round"><i class="fa fa-envelope-o"></i></a>
                                <a href="#pablo" class="btn btn-primary btn-icon btn-round"><i class="fa fa-wechat"></i></a>
                            </div>
                        </div>
                        <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="section section-contact-us text-center">
            <div class="container">
                ...
                <p class="description">你将会成为很重要的一员！</p>
                <div class="row">
                    <div class="col-lg-6 text-center col-md-8 ml-auto mr-auto">
                        ...
                        <div class="textarea-container">
                            <textarea class="form-control" name="name" rows="4" cols="80" placeholder="个人简介"></textarea>
                        </div>
